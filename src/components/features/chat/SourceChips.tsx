'use client'
import { CommentOutlined, LinkOutlined, SearchOutlined, ShoppingCartOutlined } from '@ant-design/icons'
...
function PlatformBadge({ platform }: { platform: string }) {
  ...
  if (platform === 'youtube') return <YouTubeLogo size={12} />
  if (platform === 'tiktok') return <TikTokLogo size={12} />
  return null
}
