...
import { useAgentStream } from '@/src/hooks/useChat'
import { useChatStore } from '@/src/store/chatStore'
import { useUIStore } from '@/src/store/uiStore'
import { genId, toTitle } from '@/src/lib/utils'
import { historyApi, messageToRow } from '@/src/lib/api/history'
import type { ChatSession, HistoryMessage, Message } from '@/src/types/chat'

const GUEST_LIMIT = 3

export function useSendMessage(userRef: MutableRefObject<User | null>) {
